...
import { Srm2ItemDbDBActions } from '@/modules/basic-data/srm2/srm2-items/db/actions/srm2-items-db-actions';
...
export class UpdateItemConsumer extends WorkerHost {
    constructor(
        @InjectQueue(SRM2_ITEM_TRANSPORT)
        private readonly transportQueue: Queue,
        @InjectQueue(SRM2_ITEM_UPDATE)
        private readonly updateQueue: Queue,
        private readonly dbActions: Srm2ItemDbDBActions,
    ) {
        super();
    }
